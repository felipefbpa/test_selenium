...
# Clicando para fazer Checkout
browser.find_element(By.ID, "checkout").click()

# Preenchedo informações
name = browser.find_element(By.XPATH, "//input[@id='first-name']").send_keys("Felipe")
last_name = browser.find_element(By.XPATH, "//input[@id='last-name']").send_keys("Antunes")
cep = browser.find_element(By.XPATH, "//input[@id='postal-code']").send_keys("91130-040")
...
assert browser.find_element(By.XPATH, "//*[@class='complete-header' and text()='Thank you for your order!']").is_displayed()
